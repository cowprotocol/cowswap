...
export const getNativeOrderDeadlineTooltip = (symbols: (string | undefined)[] | undefined) => (
  <Trans>
    <p>
      {symbols?.[0] || 'Native currency (e.g ETH)'} orders require a minimum transaction deadline threshold of{' '}
...
export const getNonNativeOrderDeadlineTooltip = () => (
  <Trans>
    <p>
