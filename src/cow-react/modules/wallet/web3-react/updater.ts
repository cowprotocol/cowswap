...
import { useIsGnosisApp, useWalletMetaData } from '@cow/modules/wallet'
...
function _useSafeInfo(walletInfo: WalletInfo): GnosisSafeInfo | undefined {
  ...
  }, [setSafeInfo, chainId, account, isGnosisSafe, provider, isReadOnly])
