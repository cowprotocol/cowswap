...
function SmartQuoteSelection() {
  const rates = [
    ...
    buildActiveRateDisplay(USDT_GOERLI, COW_GOERLI, 6704, 12),
    buildActiveRateDisplay(COW_GOERLI, USDT_GOERLI, 100, 6433),
    buildActiveRateDisplay(GNO_GOERLI, WETH_GOERLI, 12, 600),
    buildActiveRateDisplay(WETH_GOERLI, GNO_GOERLI, 600, 12),
    buildActiveRateDisplay(WBTC_GOERLI, GNO_GOERLI, 5, 2500),
    buildActiveRateDisplay(GNO_GOERLI, WBTC_GOERLI, 2500, 5),
  ]
