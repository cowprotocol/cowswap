...
export function LimitOrdersWidget() {
  ...
  const inputViewAmount = formatAmountInput(inputCurrencyAmount, inputCurrencyBalance, orderKind === OrderKind.SELL)
  ...
  const outputCurrencyInfo: CurrencyInfo = {
    ...
    viewAmount: isWrapOrUnwrap
      ? inputViewAmount
      : formatAmountInput(outputCurrencyAmount, outputCurrencyBalance, orderKind === OrderKind.BUY),
