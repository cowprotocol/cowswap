...
import MERKLE_DROP_ABI from 'cow-react/abis/MerkleDrop.json'
import TOKEN_DISTRO_ABI from 'cow-react/abis/TokenDistro.json'
import { MerkleDrop, TokenDistro } from 'cow-react/abis/types'
