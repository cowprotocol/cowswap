...
import LogoETH from '@src/legacy/assets/cow-swap/network-mainnet-logo.svg'
import LogoGNO from '@src/legacy/assets/cow-swap/gno.png'
import LogoUSDC from '@src/legacy/assets/cow-swap/usdc.png'
import LogoXDAI from '@src/legacy/assets/cow-swap/xdai.png'
