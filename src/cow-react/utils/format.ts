...
export function formatSymbol(symbol: string | undefined): string | undefined {
  return symbol && symbol.length > MAX_SYMBOL_LENGTH ? symbol.slice(0, MAX_SYMBOL_LENGTH) + '...' : symbol
}
