...
type CoWSwapEthFlowConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>

const isSuperArgs = (xs: CoWSwapEthFlowConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1

export class CoWSwapEthFlow__factory extends ContractFactory {
  constructor(...args: CoWSwapEthFlowConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args)
    } else {
  ...
  override deploy(
    _cowSwapSettlement: PromiseOrValue<string>,
  ...
  override attach(address: string): CoWSwapEthFlow {
    return super.attach(address) as CoWSwapEthFlow
  }
  override connect(signer: Signer): CoWSwapEthFlow__factory {
