...
const Fixtures = {
  'default (alert)': (
    <Wrapper>
    <InlineBanner
      content={<strong>This is an alert banner.</strong>}
    />
    </Wrapper>
  ),
  alert: (
    ...
    <InlineBanner
      type='alert'
      content={<strong>This is an alert banner (explicitly passed type).</strong>}
    />
    </Wrapper>
  ),
  information: (
  ...
  success: (
    ...
    <InlineBanner
      type='success'
      content={<strong>Operation completed successfully!</strong>}
    />
    </Wrapper>
  ),
  danger: (
    ...
    <InlineBanner
      type='danger'
      content={<strong>Something went wrong! Please try again.</strong>}
    />
    </Wrapper>
  ),
  smallVolumeWarning: (
