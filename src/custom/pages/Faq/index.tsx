    ...
    <Wrapper ref={faqRef}>
      ...
      <Page>
        <Content>
          ...
          <p>
            Yes,{' '}
            <ExternalLink href="https://etherscan.io/address/0xd057b63f5e69cf1b929b356b579cba08d7688048">
              vCOW
            </ExternalLink>{' '}
          ...
          <h3 id="where-can-you-swap-vcow-tokens-for-the-new-cow-tokens">Where can you swap vCOW tokens for the new COW token?</h3>
          <p> Directly in the CowSwap UI. Simply click on the profile section at the top left of the page, or in the menu if you are on mobile,
              and you will be redirected to a page where you can see your total combined balance for COW and vCOW and convert them instantly. 
          </p>
