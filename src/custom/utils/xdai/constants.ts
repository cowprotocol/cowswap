...
export const USDT_XDAI = new Token(ChainId.XDAI, '0x4ECaBa5870353805a9F068101A40E0f32ed605C6', 6, 'USDT', 'Tether USD')
...
export const OWL_XDAI = new Token(ChainId.XDAI, '0x0905Ab807F8FD040255F0cF8fa14756c1D824931', 18, 'OWL', 'OWL')
