...
import { getQuote, getPriceQuoteLegacy as getPriceQuoteGp } from 'cow-react/api/gnosisProtocol'
import GpQuoteError, { GpQuoteErrorCodes } from 'cow-react/api/gnosisProtocol/errors/QuoteError'
...
import {
  ...
  LegacyQuoteParams,
} from 'cow-react/api/gnosisProtocol/legacy/types'
