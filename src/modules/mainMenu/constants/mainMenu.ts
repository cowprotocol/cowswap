...
// Assets
import IMAGE_DOCS from '@src/legacy/assets/cow-swap/doc.svg'
import IMAGE_TERMS_AND_CONDITIONS from '@src/legacy/assets/cow-swap/terms-and-conditions.svg'
import IMAGE_COOKIE_POLICY from '@src/legacy/assets/cow-swap/cookie-policy.svg'
import IMAGE_PRIVACY_POLICY from '@src/legacy/assets/cow-swap/privacy-policy.svg'
import IMAGE_INFO from '@src/legacy/assets/cow-swap/info.svg'
import IMAGE_CODE from '@src/legacy/assets/cow-swap/code.svg'
import IMAGE_DISCORD from '@src/legacy/assets/cow-swap/discord.svg'
import IMAGE_TWITTER from '@src/legacy/assets/cow-swap/twitter.svg'
import IMAGE_PIE from '@src/legacy/assets/cow-swap/pie.svg'
import IMAGE_SLICER from '@src/legacy/assets/cow-swap/ninja-cow.png'
import IMAGE_GAME from '@src/legacy/assets/cow-swap/game.gif'
