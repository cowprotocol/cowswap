...
import { SAFE_COW_APPLINK, UNSUPPORTED_WALLET_LINK } from 'modules/twap/const'
    ...
    return (
      <InlineBanner type="information">
        ...
        <p>
          ...
          Only available in the <ExternalLink href={SAFE_COW_APPLINK}>CoW Swap Safe App↗</ExternalLink>
        </p>
      </InlineBanner>
    )
  }
