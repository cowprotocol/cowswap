...
const LABELS_TOOLTIPS: LabelTooltipItems = {
  ...
  totalDuration: {
    ...
    tooltip: (
      <>
        The "Total duration" is the duration it takes to execute all parts of your TWAP order. For instance, your
        order consists of 2 parts placed every 30 minutes, the total time to complete the order is 1 hour. Each limit
        order remains open for 30 minutes until the next part becomes active.
      </>
    ),
  },
  partDuration: {
    ...
    tooltip: (
      <>
        The "Part duration" refers to the duration between each part of your TWAP order. Choosing a shorter time
        allows for faster execution of each part, potentially reducing price fluctuations. Striking the right balance
        is crucial for optimal execution.
      </>
    ),
  },
  slippage: {
    ...
    tooltip: (
      <>
        ...
        your slippage should take into account possible price fluctuations over that time. If your slippage is too
        low, you risk some parts of your order failing to execute.
      </>
    ),
  },
  price: {
