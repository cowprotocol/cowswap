...
import GameIcon from '@src/legacy/assets/cow-swap/game.gif'
...
import checkImage from '@src/legacy/assets/cow-swap/check.svg'
import alertImage from '@src/legacy/assets/cow-swap/alert-circle.svg'
