...
import Sushi from '@src/legacy/assets/cow-swap/ammslogo/sushi.png'
import Paraswap from '@src/legacy/assets/cow-swap/ammslogo/paraswap.png'
import Oneinch from '@src/legacy/assets/cow-swap/ammslogo/1inch.png'
import Uniswap from '@src/legacy/assets/cow-swap/ammslogo/uniswap.png'
import Baoswap from '@src/legacy/assets/cow-swap/ammslogo/baoswap.png'
import Honeyswap from '@src/legacy/assets/cow-swap/ammslogo/honeyswap.png'
import Swapr from '@src/legacy/assets/cow-swap/ammslogo/swapr.png'
import Curve from '@src/legacy/assets/cow-swap/ammslogo/curve.png'
import Matcha from '@src/legacy/assets/cow-swap/ammslogo/matcha.png'
import Levinswap from '@src/legacy/assets/cow-swap/ammslogo/levinswap.png'
import Elk from '@src/legacy/assets/cow-swap/ammslogo/elk.png'
import Symmetric from '@src/legacy/assets/cow-swap/ammslogo/symmetric.png'
import ZeroX from '@src/legacy/assets/cow-swap/ammslogo/0x.png'
