...
import BROKEN_LIST from '@src/legacy/constants/tokenLists/broken.tokenlist.json'
import UNSUPPORTED_TOKEN_LIST from '@src/legacy/constants/tokenLists/unsupported.tokenlist.json'
