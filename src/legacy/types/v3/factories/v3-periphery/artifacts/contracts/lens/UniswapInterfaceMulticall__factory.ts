...
} from '../../../../../v3-periphery/artifacts/contracts/lens/UniswapInterfaceMulticall'
...
type UniswapInterfaceMulticallConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>
...
export class UniswapInterfaceMulticall__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<UniswapInterfaceMulticall> {
