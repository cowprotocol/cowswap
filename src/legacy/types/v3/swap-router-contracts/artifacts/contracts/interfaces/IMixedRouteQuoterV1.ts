...
export declare namespace IMixedRouteQuoterV1 {
  ...
  export type QuoteExactInputSingleV2ParamsStructOutput = [string, string, BigNumber] & {
    tokenIn: string
    tokenOut: string
    amountIn: BigNumber
  }
  ...
  export type QuoteExactInputSingleV3ParamsStructOutput = [string, string, BigNumber, number, BigNumber] & {
    tokenIn: string
    tokenOut: string
    amountIn: BigNumber
    fee: number
...
export interface IMixedRouteQuoterV1Interface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: 'quoteExactInput' | 'quoteExactInputSingleV2' | 'quoteExactInputSingleV3'
  ): FunctionFragment
