...
- `MUST` pin dependency versions in `package.json` files (exact semver); `workspace:*` and explicit package artifact sources (`https://...tgz`, `file:`, `link:`, `portal:`, `patch:`) are allowed.
