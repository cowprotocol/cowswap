...
import { CowSwapWidgetSettings, TradeType } from './types'

export function buildWidgetUrl(params: CowSwapWidgetSettings): string {
...
export function buildWidgetPath(params: CowSwapWidgetSettings): string {
...
export function buildTradeAmountsQuery(params: CowSwapWidgetSettings): URLSearchParams {
