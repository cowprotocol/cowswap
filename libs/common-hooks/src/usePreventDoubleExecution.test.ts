...
describe('usePreventDoubleExecution', () => {
  describe('basic functionality', () => {
    ...
    it('should return the result from the function', async () => {
      ...
      await act(async () => {
        actualResult = await result.current() as string | undefined
      })
  ...
  describe('hook dependencies', () => {
    it('should recreate callback when function changes', () => {
      ...
      const { result, rerender } = renderHook(
        ({ fn }) => usePreventDoubleExecution(fn),
  ...
  describe('edge cases', () => {
    it('should handle function that returns undefined', async () => {
      ...
      await act(async () => {
        actualResult = await result.current() as undefined
      })
    ...
    it('should handle function that returns null', async () => {
      ...
      await act(async () => {
        actualResult = await result.current() as null | undefined
      })
    ...
    it('should handle function that returns 0', async () => {
      ...
      await act(async () => {
        actualResult = await result.current() as number | undefined
      })
  ...
  describe('concurrent execution scenarios', () => {
    ...
    it('should handle mixed success and failure scenarios', async () => {
      ...
      await act(async () => {
        const result1 = await result.current() as string | undefined
      ...
      await act(async () => {
        const result3 = await result.current() as string | undefined
