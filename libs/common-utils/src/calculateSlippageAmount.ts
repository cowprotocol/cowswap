import { Currency, CurrencyAmount, Fraction, Percent } from '@cowprotocol/currency'

const ONE_FRACTION = new Fraction(1, 1)

export function calculateSlippageAmount(value: CurrencyAmount<Currency>, slippage: Percent): [bigint, bigint] {
