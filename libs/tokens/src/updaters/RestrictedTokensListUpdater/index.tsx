...
export function RestrictedTokensListUpdater({ isRwaGeoblockEnabled }: RestrictedTokensListUpdaterProps): null {
  const { shouldFetch: shouldFetchTokens, hasFreshCache, saveToCache } = useRestrictedTokensCache()
  ...
  }, [isRwaGeoblockEnabled, hasFreshCache, saveToCache, setRestrictedLists, setRestrictedTokens, shouldFetch])
