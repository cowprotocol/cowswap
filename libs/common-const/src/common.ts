...
const DEFAULT_ETH_FLOW_SLIPPAGE_WARNING = 200 // 2%
export const ETH_FLOW_SLIPPAGE_WARNING_BORDER: Record<SupportedChainId, number> = {
  [SupportedChainId.MAINNET]: 500, // 5%
  [SupportedChainId.GNOSIS_CHAIN]: DEFAULT_ETH_FLOW_SLIPPAGE_WARNING,
  [SupportedChainId.ARBITRUM_ONE]: DEFAULT_ETH_FLOW_SLIPPAGE_WARNING,
  [SupportedChainId.BASE]: DEFAULT_ETH_FLOW_SLIPPAGE_WARNING,
  [SupportedChainId.SEPOLIA]: DEFAULT_ETH_FLOW_SLIPPAGE_WARNING,
  [SupportedChainId.POLYGON]: DEFAULT_ETH_FLOW_SLIPPAGE_WARNING,
  [SupportedChainId.AVALANCHE]: DEFAULT_ETH_FLOW_SLIPPAGE_WARNING,
}
