...
import GnosisChainLogo from '@cowswap/assets/cow-swap/network-gnosis-chain-logo.svg'
import GoerliLogo from '@cowswap/assets/cow-swap/network-goerli-logo.svg'
import EthereumLogo from '@cowswap/assets/cow-swap/network-mainnet-logo.svg'
