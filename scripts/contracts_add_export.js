...
const fileTypesIndex = path.resolve(__dirname, '../src/custom/abis/types/index.ts')
...
fs.appendFile(fileTypesIndex, outputEthFlowAbis, function (err) {
  ...
  console.log('Successfully added contracts export script targetting custom/types/ethflow/index.ts!')
})
