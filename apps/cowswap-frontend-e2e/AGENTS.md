...
## App commands
- Run e2e: `pnpm nx run cowswap-frontend-e2e:e2e` (or `pnpm e2e` to run all e2e targets)
- Open Cypress: `pnpm nx run cowswap-frontend-e2e:e2e:open` (or `pnpm e2e:open`)
- Lint: `pnpm nx run cowswap-frontend-e2e:lint`
