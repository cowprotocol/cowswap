 ...
 */
export type TypedDataTypes = Parameters<typeof _TypedDataEncoder.hashStruct>[1]
 ...
 */
export function isJsonRpcProvider(provider: Provider): provider is JsonRpcProvider {
