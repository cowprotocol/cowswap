import { QA_CONNECT_INJECTED_WALLET_EVENT, QA_FORCE_ONCHAIN_APPROVAL_SESSION_KEY } from '@cowprotocol/common-const/qa'
...
export async function forceOnchainApproval(page: Page): Promise<void> {
  ...
  }, QA_FORCE_ONCHAIN_APPROVAL_SESSION_KEY)
}
...
export async function connectInjectedWallet(page: Page): Promise<void> {
  ...
  }, QA_CONNECT_INJECTED_WALLET_EVENT)
