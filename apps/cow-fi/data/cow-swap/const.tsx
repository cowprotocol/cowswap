  ...
  },
  {
    ...
    answer: (
      <>
        ...
        our pages on{' '}
        <Link href="https://www.cow.fi" utmContent="cow-website">
          www.cow.fi
        </Link>
        .
        <br />
        ...
        <br />
        X:{' '}
        <Link href="https://x.com/CoWSwap" external utmContent="cow-twitter">
          https://x.com/CoWSwap
        </Link>
        <br />
        Discord:{' '}
        ...
        <br />
        Forum:{' '}
        <Link href="https://forum.cow.fi/" external utmContent="cow-forum">
          https://forum.cow.fi/
        </Link>
        <br />
        Snapshot:{' '}
        <Link href="https://snapshot.org/#/cow.eth" external utmContent="cow-snapshot">
          https://snapshot.org/#/cow.eth
        </Link>
        <br />
        Github:{' '}
        <Link href="https://github.com/cowprotocol/" external utmContent="cow-github">
