        ...
        <ContainerCard bgColor={Color.neutral100} minHeight="70vh" gap={62} gapMobile={42} centerContent touchFooter>
          <ArticleContent maxWidth="100%">
            ...
            <BodyContent>
              ...
              <p>
                By integrating and using the Widget, you confirm that you accept these Terms and agree to comply with
                them. If you do not agree, you must not integrate the Widget. If you think that there is an error in
              ...
              <p>
                We may terminate or suspend your access to the Widget immediately, without prior notice or liability, if
                you breach any clause of the Terms. Upon termination of your access, your right to access the website or
                use the Products will immediately cease.
              </p>
              ...
              <p>
                CoW Protocol applies batch auction mechanisms to allow peer-to-peer trades on Ethereum Mainnet, and
                Ethereum Virtual Machine compatible validation mechanisms. CoW DAO is not custodians or counterparties
                to any transactions executed by you on the Protocol. We do not support any other service, particularly
                we do not provide any order matching, guaranteed prices, or similar exchange or trading platform
                services.
              </p>
              <p>
                Please consult our{' '}
              ...
              <p>
                The Partner may customize the design and appearance of the Widget within reasonable limits, provided
                that the Provider's branding and logos remain visible.
              </p>
              ...
              <ul>
                ...
                <li>
                  Technologically harmful, including attempts to disrupt or damage the Widget, the Interface, the
                  Protocol or its infrastructure.
                </li>
              </ul>
              ...
              <p>
                The Provider grants the Partner a limited, non-exclusive, non-transferable, revocable license to
                integrate and use the Widget solely for the purpose of providing access to the Interface to the
                Partner's users.
              </p>
              <p>
                The Widget and all intellectual property rights therein are and shall remain the exclusive property of
                the Provider.
              </p>
              ...
              <p>
                ...
                to earn fees on trades their users execute through the Widget. For comprehensive details and conditions
                of the Partner Fee Program, please refer to the dedicated{' '}
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://docs.cow.fi/cow-protocol/tutorials/widget#partner-fee"
                >
              ...
              <h3>Service Fee</h3>
              <p>
                The Provider will retain a service fee ("Service Fee") from the total fees earned by the Partner.
                Specific terms and conditions regarding the Service Fee are outlined in the{' '}
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://docs.cow.fi/cow-protocol/tutorials/widget#partner-fee"
              ...
              <p>
                ...
                are eligible for Partner Fee. The Provider may choose not to issue Partner Fees for any reason,
                including but not limited to:
              </p>
              <ul>
                <li>
                  Suspected Fraud or Scam Activity: Transactions involving tokens deemed fraudulent or potentially
                  involved in scams;
                </li>
                <li>
                  Abnormal or Manipulative Trading: Trading activity aimed at exploiting the Widget or Partner Fee
                  program;
                </li>
                <li>
                  Other Inappropriate Activity: Any other scenarios where the Provider considers Partner Fee payment to
                  be unsuitable or against the best interests of the Widget or Program.
                </li>
              </ul>

              <h3>Program Changes and Termination</h3>
              <p>
                The Provider may make amendments to the Program at any time. Additionally, the Provider reserves the
                right to modify or terminate the Program at any time, with or without notice.
              </p>
              ...
              <p>
                The Partner is solely responsible for ensuring compliance with all applicable laws and regulations in
                their jurisdiction.
              </p>
              <h2>Indemnification</h2>
              <p>
                The Partner shall indemnify, defend, and hold harmless the Provider, its affiliates, and their agents
                from and against any and all claims, liabilities, damages, losses, and expenses, including reasonable
                attorneys' fees and costs, arising out of or relating to the Partner's use of the Widget or breach of
                these Terms.
              </p>
              <h2>Breach of Terms</h2>
              <p>
                In the event of a breach of these Terms, the Provider may immediately terminate your use of the Widget
                or participation in the Program without notice.
              </p>
              <h2>Termination</h2>
              <p>
              ...
              <p>
                Upon termination, the Partner shall immediately cease all use of the Widget and remove it from its
              ...
              <p>
                ...
                present Terms about or in connection to the Widget between you and us (a "Dispute"), you agree to seek
                to resolve the matter with us amicably by referring the matter to{' '}
                <a href="mailto:legal@cow.fi" target="_blank" rel="noreferrer">
                  legal@cow.fi
                </a>
                .
              ...
              <p>
                ...
                under the International Chamber of Commerce ("ICC") Mediation Rules, which Rules are deemed to be
