...
export default function Page({ siteConfigData }: PageProps) {
  ...
  return (
    <Layout bgColor={Color.neutral90} metaTitle="CoW Swap - Privacy policy" metaDescription="Privacy policy for CoW">
      <Wrapper>
          ...
          <ArticleContent maxWidth="100%">
            ...
            <BodyContent>
              ...
              <p>
                ...
                or indirectly, in particular by reference to an identifier such as a name, an online identifier or to
                one or more factors specific to your physical, physiological, genetic, mental, economic, cultural or
                social identity.
              </p>
              <p>
                In this Policy, “processing” means any operation or set of operations which is performed on personal
                data (as defined in this Privacy Policy) or on sets of personal data, whether or not by automated means,
              ...
              <p>
                ...
                making decisions or otherwise administering the system (such as an operator of a cloud computing
                system), and that there is no centralised place where it is located either.
              </p>
              <p>
                Accordingly, by design, a blockchains records cannot be changed or deleted and is said to be
                ‘immutable’. This may affect your ability to exercise your rights such as your right to erasure (‘right
                to be forgotten’), or your rights to object or restrict processing of your personal data. Data on the
                blockchain cannot be erased and cannot be changed. Although smart contracts may be used to revoke
              ...
              <p>
                This data may be processed in order to deliver the content of our website or websites we host on behalf
                of clients correctly, to optimise the content of our website or websites we host on behalf of clients to
                ...
                cyber-attack. The legal basis for this processing is the legitimate business interests, namely
                monitoring and improving our website or websites we host on behalf of clients and the proper protection
                against risks.
              </p>
              <p>
                <strong>
              ...
              <ul>
                <li>
                  On the Blockchain the following data will be stored if your intent to trade is successfully included
                  in a transaction:
                  <ul>
                    <li>Your wallet address;</li>
                    ...
                    <li>Prices;</li>
                    <li>
                      AppData hash (hash of the IPFS content pointing to the appData submitted with the intent to
                      trade).
                    </li>
                  </ul>
                </li>
              ...
              <p>
                When you participate in our user experience research - or user experience research we conduct on behalf
                of our clients - we may collect and process some personal data. This data may include:
              </p>
              <ul>
              ...
              <p>
                In addition, we may take a recording of you while testing the website or website we host on behalf of
                our clients for internal use. The basis for this collection and processing is our legitimate business
                interest or that of our clients in monitoring and improving our services. You are never required to
                share information you are not comfortable sharing.
              </p>
              <p>
              ...
              <p>
                We may collect and process Personal Data about your use of our Twitter, Medium or other social media.
              ...
              <ul>
                ...
                <li>
                  ...
                  blog posts, and other marketing material; and for user demographics in order to identify target
                  markets. This data is collected and processed for the purpose of improving the content of our shared
                  links pursuant to our legitimate interests (or those of our clients). When visiting the mentioned
                  services different data protection regulations apply, please familiarise yourself with their Privacy
                  Policies.
                </li>
              </ul>
              <p>
              ...
              <p>
                ...
                claims. The legal basis for this process is our legitimate interests, namely the protection and
                assertion of our legal rights, your legal rights and the legal rights of others, including our clients.
              </p>
              <p>
              ...
              <p>
                We may use Calendly for scheduling. For further information and the applicable data protection
              ...
              <p>
                We may use Discourse for discussion. For further information and the applicable data protection
                provisions of Discourse please visit{' '}
              ...
              <p>
                We may use Dovetail for storing recordings and interviews as a user testing tool. For further
                information and the applicable data protection provisions please visit{' '}
              ...
              <p>
                We may use Google Workspace (Drive, Sheets etc.) for storing user interviews and other personal data.
                For further{' '}
              ...
              <p>
                In order to provide user support on our behalf or on behalf of our clients, we will use different
                channels like Discord, Discourse, Github or Telegram to facilitate the resolution of any questions and
                concerns should these arise. By accepting this Privacy Policy, you are deemed to consent to providing
                the following Personal Data to persons looking to resolve any dispute:
              </p>
              <ul>
              ...
              <p>
                ...
                forms for several purposes. Further information and the applicable data protection provisions of
                typeform please visit{' '}
              ...
              <p>
                We may use Zoom for active user research interviews and taking recordings. These records may be stored
                on Zoom Cloud. For further information and the applicable data protection provisions please visit{' '}
              ...
              <p>
                In addition, we may transfer your personal information to a third party as part of a sale of some, or
                all, of our business and assets or as part of any business restructuring or reorganisation, or if we are
              ...
              <p>
                ...
                your personal data to those employees (if applicable), agents, contractors and other third parties who
                have a business need to know. They will only process your personal data on our instructions and they are
                subject to a duty of confidentiality. Please note that intents to trade are publicly accessible via the
              ...
              <ul>
                <li>
                  ...
                  <p>
                    You have a right to be informed about the processing of your personal data (and if you did not give
                    it to us, information as to the source) and this Privacy Policy intends to provide the information.
                    Of course, if you have any further questions you can contact us on the below details.
                  </p>
                </li>
                <li>
                ...
                <li>
                  ...
                  <p>
                    ...
                    This may impact the services we can provide and we will explain this to you if you decide to
                    exercise this right.
                  </p>
                </li>
                <li>
                  ...
                  <p>
                    ...
                    entering into a contract, you have a right to receive the personal information you provided to us in
                    a structured, commonly used and machine-readable format, or ask us to send it to another person.
                  </p>
                </li>
                <li>
                  ...
                  <p>
                    We do not use automated decision-making, but where any automated decision-making takes place, you
                    have the right in this case to express your point of view and to contest the decision, as well as
                    request that decisions based on automated processing concerning you or significantly affecting you
                    and based on your personal data are made by natural persons, not only by computers.
                  </p>
                </li>
                <li>
                  ...
                  <p>
                    ...
                    ‘unsubscribe’ button on our marketing emails or choosing a similar opt-out option on any forms we
                    ...
                    aware that your ability to opt-out from receiving marketing and promotional materials does not
                    change our right to contact you regarding your use of our website or websites we host on behalf of
                    clients or as part of a contractual relationship we may have with you.
                  </p>
                </li>
                <li>
                  ...
                  <p>
                    ...
                    details of your Personal Information that we hold or process. To protect your personal information,
                    we follow set storage and disclosure procedures, which mean that we will require proof of identity
                    from you prior to disclosing such information. You can exercise this right at any time by contacting
                    us on the below details.
                  </p>
                </li>
                <li>
                  <h3 id="right-to-withdraw-consent">Right to withdraw consent</h3>
                  <p>
                    Where the legal basis for processing your personal information is your consent, you have the right
                    to withdraw that consent at any time by contacting us on the below details.
                  </p>
                </li>
                <li>
                  ...
                  <p>
                    If you wish to raise a complaint on how we have handled your personal data, you can contact us as
                    set out below and we will then investigate the matter.
                  </p>
                </li>
                <li>
                  ...
                  <p>
                    ...
                    habitual residence, place of work, or the place where you allege an infringement of one or more of
                    our rights has taken place, if that is based in the EEA.
                  </p>
                </li>
              </ul>
              ...
              <p>
                ...
                change the ‘Last updated’ date above. We encourage you to review the Policy whenever you access or use
                our website or websites we host on behalf of clients to stay informed about information practices and
                the choices available to you. If you do not agree to the revised Policy, you should discontinue your use
                of this website.
              </p>
              ...
              <p>
                ...
                registration number PT516811924, and our registered office is located at Rua António Maria Cardoso, No
                25, piso 4, 1200-027 Lisboa.
              </p>
              <p>
...
export const getStaticProps: GetStaticProps<PageProps> = async () => {
  return {
    props: {
      siteConfigData: {
        ...CONFIG,
        title: 'Privacy policy for CoW Swap',
        descriptionShort: 'Privacy policy',
      },
    },
