          ...
          <ArticleContent maxWidth="100%">
            ...
            <BodyContent>
              ...
              <p>
                ...
                such as Ethereum and Gnosis Chain and emerging solutions within Ethereum layer 2 solutions. The
                management of CoW DAO is in accordance with its participation agreement. For any inquiries or to
                establish contact with CoW DAO, please use the forum at{' '}
              ...
              <p>
                ...
                accessible. This means anyone can view the details of your transactions, including the amount, sender,
                and receiver addresses. While this transparency offers benefits like security and trust, it also means
                your privacy is not guaranteed. If you require anonymity or confidentiality for your transactions,
              ...
              <p>
                ...
                to sell to any other destination other than the Protocol smart contracts, such tokens may not be
                returned. We assume no responsibility and shall have no obligation to you if this occurs, including but
                not limited to any responsibility to recover, or assist to recover, any such tokens.
              </p>
              ...
              <p>
                You are also responsible for ensuring that all persons who access the Website or the Products through
                your internet connection or device are aware of these Terms and that they comply with them.
              </p>
              <p>
                We may terminate or suspend your access to the Website or the Products immediately, without prior notice
                or liability, if you breach any clause of the Terms. Upon termination of your access, your right to
                access the website or use the Products will immediately cease.
              </p>
              ...
              <p>
                ...
                submit orders into the Interface and exchange compatible tokens using the unique features of the
                Protocol.
              </p>
              <p>
                Please consult our{' '}
              ...
              <p>
                To use the Interface, you must be legally capable of entering into a contract. Therefore, you confirm
                that you are of legal age in your jurisdiction and have the full rights, powers, and authority to enter
                into and abide by these Terms on your own behalf and on behalf of any company, legal entity or any other
              ...
              <p>
                ...
                regulations, and you will not use the Interface to conduct, promote, or facilitate any illegal
                activities.
              </p>
              ...
              <p>
                You may have been recommended to the Interface by a third party. We shall not be liable for any
                agreement or terms that may exist between you and the respective third party.
              </p>
              ...
              <p>
                ...
                our Interface, you agree to be bound by these Terms and all of the terms incorporated herein by
                reference.
              </p>
              <p>
              ...
              <p>
                The user may incur a fee at protocol level, which - if technically possible - is shown to the user on
                the Interface when the user places their trade intent. Such a fee is designed in accordance with the
              ...
              <p>
                ...
                the sole responsibility of the user of the Widget to carefully review the terms and conditions provided
                by the third-party integrator before using Widget.
              </p>
              ...
              <p>
                The Interface operates as a non-custodial application, which implies that we, at no point in time,
                assume custody, ownership, or control over your digital assets.
              </p>
              <p>
                ...
                wallet rests solely with you, and we shall not be held responsible for any actions or omissions
                undertaken by you in relation to or as a consequence of your wallet being compromised.
              </p>
              ...
              <p>
                In order to use the Forum Name, you may be required to register for an account. You must provide
                accurate and complete information when registering and you are responsible for keeping your account
                information up-to-date and secure. You agree not to share your account information with anyone else.
              </p>
              <h3 id="acceptable-use">Acceptable Use</h3>
              <p>
                You agree not to post any content that is unlawful, harmful, threatening, abusive, harassing,
                defamatory, vulgar, obscene, invasive of another&#39;s privacy, or otherwise promoting illegal or
                harmful activities.
              </p>
              <p>
              ...
              <p>
                None of the information available on the Website including the Interface and the Forum, or made
                otherwise available to you in relation to its use, constitutes any legal, tax, financial or other
                advice. When in doubt as to the action you should take, you should consult your legal, financial, tax or
                other professional advisors.
              </p>
              <h2 id="intellectual-property-rights">Intellectual Property Rights</h2>
              <p>
                Subject to the application of any miscellaneous open source license attaching to the software code of
                the Protocol and to the software code of the Products, we are the owner of all contents, including but
                not limited to software, text, images, trademarks, service marks, copyrights, patents, and designs. This
                means we own all the legal rights to them. You are not allowed to copy, modify, adapt, rent, license,
                sell, publish, distribute, or share access to the Interface or its contents with anyone else, unless we
              ...
              <p>
                ...
                non-transferable, non-sublicensable licence to access the Protocol and the Products. This licence does
                not include any resale, commercial or derivative use of the Protocol or the Products. We reserve and
                retain all rights not expressly granted to you in these Terms. The Interface may not be reproduced,
                sold, or otherwise exploited for any commercial purpose without our express prior written consent. You
                may not frame or utilize framing techniques to enclose any trademark, logo, or other proprietary
                information of us without our express prior written consent. You may not misuse the Interface and may
                only use it as permitted by law. If you breach our intellectual property rights in violation of these
              ...
              <ul>
                ...
                <li>
                  <p>
                    Technologically harmful, including attempts to disrupt or damage the Interface or its
                    infrastructure.
                  </p>
                </li>
              </ul>
              ...
              <p>
                You agree to release and indemnify, defend and hold us and any of our affiliates harmless, as well as
                any members, participants, directors, officers, employees, contractors, shareholders and representatives
                of any of the foregoing, from and against any and all losses, liabilities, damages, costs claims or
                actions of any kind arising or resulting from your use of the Interface, your breach of these Terms, and
                any of your acts or omissions that infringe the rights of any person.
              </p>
              <p>
                We reserve the right, at our own expense, to assume exclusive defence and control of any matter
                otherwise subject to indemnification by you and, in such case, you agree to cooperate with us in the
                defence of such matter.
              </p>
              <p>
                The indemnity set out here is in addition to, and not in lieu of, any other remedies that may be
              ...
              <ul>
                ...
                <li>
                  ...
                  in the APPENDIX, which is hereby expressly incorporated into these Terms, and you are willing to
              ...
              <p>
                You are responsible for ensuring you are interacting with the correct URL and taking necessary
                precautions to avoid scams or fraudulent activities impersonating us.
              </p>
              ...
              <p>
                In the event a Dispute cannot be resolved amicably, you must first refer the Dispute to proceedings
                under the International Chamber of Commerce (&quot;ICC&quot;) Mediation Rules, which Rules are deemed to
                be incorporated by reference into this clause. The place of mediation shall be London, United Kingdom.
              ...
              <p>
                ...
                appointed in accordance with the said Rules. The seat of Arbitration shall be London, United Kingdom.
                The governing law of this arbitration clause shall be the laws of England and Wales. The language of the
              ...
              <p>
                If the Dispute cannot be resolved for legal reasons in accordance with the procedures described above,
                you and we agree that the courts of England and Wales shall have exclusive jurisdiction to resolve the
                Dispute.
              </p>
              ...
              <p>
                Subject to 20.1, these Terms do not give rise to any third party rights, which may be enforced against
                Us.
              </p>
              ...
              <p>
                ...
                matter, and supersede and replace any previous or contemporaneous written or oral contract, promises,
                assurances, assurances, warranty, representation or understanding regarding its subject matter, whether
                written or oral. You shall have no claim for innocent or negligent misrepresentation or misstatement
                based on any statement in these Terms, though nothing in this clause shall limit or exclude any
                liability for fraud.
              </p>
              <h2 id="no-waiver-and-no-assignment">No waiver and no assignment</h2>
              <p>
                You may not assign, transfer or delegate any of your rights or duties arising out of or in connection
                with these Terms to a third party. Any such assignment or transfer shall be void and shall not impose
                any obligation or liability on us to the assignee or transferee.
              </p>
              <p>
