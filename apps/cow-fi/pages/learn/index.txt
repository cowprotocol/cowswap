...
import { Section, SectionContent, SubTitle, SectionImage } from '@/components/Home/index.styles'
          ...
          <div className="container">
            ...
            <ButtonWrapper>
              ...
              <LinkWithUtm
                ...
                passHref
              >
                <Button paddingLR={4.2} fontSizeMobile={2.1} label="Read docs" variant={ButtonVariant.TEXT_LIGHT} />
              </LinkWithUtm>
            </ButtonWrapper>
          </div>
          <SectionImage>
