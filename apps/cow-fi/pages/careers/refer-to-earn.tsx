      ...
      <Wrapper>
        <ContainerCard bgColor={Color.neutral100} minHeight="70vh" gap={62} gapMobile={42} centerContent touchFooter>
          <ArticleContent maxWidth="100%">
            <Breadcrumbs>
              <a href="/careers" data-click-event="click-breadcrumb-careers">
                Careers
              </a>
            ...
            <BodyContent>
              ...
              <ul>
                ...
                <li>
                  ...
                  <b>
                    When applying, Candidates must mention the name and email of the person (or entity) who referred
                    them.
                  </b>{' '}
                ...
                <li>
                  ...
                  Candidate&apos;s status and the timeline for the start date. Referrers should not contact CoW
                  requesting such information.
                </li>
                <li>
                  CoW is not obligated to disclose the reason for rejecting a Candidate to a Referrer or to inform them
                  if the Candidate was not selected for the next steps in the interview process.
                </li>
