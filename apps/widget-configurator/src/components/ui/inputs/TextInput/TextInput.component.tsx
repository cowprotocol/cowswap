...
export function TextInput({ name, value, onChange, onBlur, ...props }: TextInputProps): ReactNode {
  ...
  return <BaseTextInput {...props} name={name} value={value || ''} onChange={handleChange} onBlur={handleBlur} />
}
