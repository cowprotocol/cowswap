...
export const DEFAULT_TOKEN_LISTS: TokenListItem[] = [
  ...
  { url: 'https://compli.fi/complifi.tokenlist.json', enabled: false },
  { url: 'https://www.coingecko.com/tokens_list/uniswap/defi_100/v_0_0_0.json', enabled: false },
  {
    url: 'https://raw.githubusercontent.com/compound-finance/token-list/master/compound.tokenlist.json',
    enabled: false,
  },
  { url: 'https://defiprime.com/defiprime.tokenlist.json', enabled: false },
  {
  ...
  { url: 'https://cdn.furucombo.app/furucombo.tokenlist.json', enabled: false },
  { url: 'https://www.gemini.com/uniswap/manifest.json', enabled: false },
  { url: 'https://t2crtokens.eth.link', enabled: false },
  { url: 'https://api.kyber.network/tokenlist', enabled: false },
  { url: 'https://messari.io/tokenlist/messari-verified', enabled: false },
  { url: 'https://uniswap.mycryptoapi.com/', enabled: false },
  { url: 'https://raw.githubusercontent.com/opynfinance/opyn-tokenlist/master/opyn-v1.tokenlist.json', enabled: false },
  ...
  { url: 'https://list.tkn.eth.link', enabled: false },
  ...
  { url: 'https://umaproject.org/uma.tokenlist.json', enabled: false },
  { url: 'https://wrapped.tokensoft.eth.link', enabled: false },
  { url: 'https://yearn.science/static/tokenlist.json', enabled: false },
  { url: 'https://zapper.fi/api/token-list', enabled: false },
  { url: 'https://tokenlist.zerion.eth.link', enabled: false },
]
