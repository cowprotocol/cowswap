...
function reClassifyOrder(
  ...
  const existingIsCancelling = existingOrder?.order.isCancelling
  ...
  return {
    ...
    isCancelling: PENDING_STATES.includes(incomingStatus) ? existingIsCancelling || newOrder.isCancelling : false,
  }
}
