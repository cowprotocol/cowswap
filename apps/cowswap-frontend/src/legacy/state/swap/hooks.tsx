...
import { changeSwapAmountAnalytics, switchTokensAnalytics } from '../../components/analytics'
import { FEE_SIZE_THRESHOLD } from '../../constants'
...
import { stringToCurrency, useTradeExactInWithFee, useTradeExactOutWithFee } from './extension'
import TradeGp from './TradeGp'
import { isWrappingTrade } from './utils'
import { useIsExpertMode } from '../user/hooks'
