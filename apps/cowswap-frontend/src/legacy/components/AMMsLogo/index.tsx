...
import ZeroX from '@cowswap/assets/cow-swap/ammslogo/0x.png'
import Oneinch from '@cowswap/assets/cow-swap/ammslogo/1inch.png'
import Baoswap from '@cowswap/assets/cow-swap/ammslogo/baoswap.png'
import Curve from '@cowswap/assets/cow-swap/ammslogo/curve.png'
import Elk from '@cowswap/assets/cow-swap/ammslogo/elk.png'
import Honeyswap from '@cowswap/assets/cow-swap/ammslogo/honeyswap.png'
import Levinswap from '@cowswap/assets/cow-swap/ammslogo/levinswap.png'
import Matcha from '@cowswap/assets/cow-swap/ammslogo/matcha.png'
import Paraswap from '@cowswap/assets/cow-swap/ammslogo/paraswap.png'
import Sushi from '@cowswap/assets/cow-swap/ammslogo/sushi.png'
import Swapr from '@cowswap/assets/cow-swap/ammslogo/swapr.png'
import Symmetric from '@cowswap/assets/cow-swap/ammslogo/symmetric.png'
import Uniswap from '@cowswap/assets/cow-swap/ammslogo/uniswap.png'
