...
import { COW_PROTOCOL_VAULT_RELAYER_ADDRESS, MAX_UINT256 } from '@cowprotocol/cow-sdk'
...
export const TokensTableRow = ({
  ...
  const amountToApprove = useMemo(() => CurrencyAmount.fromRawAmount(tokenData, MAX_UINT256), [tokenData])
