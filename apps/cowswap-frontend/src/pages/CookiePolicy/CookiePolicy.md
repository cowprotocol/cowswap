...
| __cookielawinfo_checkbox_necessary     | xCookie set by GDPR cookie consent plug-in. Cookie used to save the agreement of the user for category “necessary”.                               | 1 year from set/update   | User activity won't be tracked         |
