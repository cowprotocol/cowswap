            ...
            <ActionBtn onClick={() => setShowQrModal(true)}>
              <QrIconWrapper>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M3 3h7v7H3V3zm2 2v3h3V5H5zm9-2h7v7h-7V3zm2 2v3h3V5h-3zM3 14h7v7H3v-7zm2 2v3h3v-3H5zm11 0h2v2h-2v-2zm2-2h2v2h-2v-2zm-4 4h2v2h-2v-2zm2 0h2v2h-2v-2zm0 2h2v2h-2v-2zm2-4h2v2h-2v-2z" />
                </svg>
              </QrIconWrapper>
              <Trans>Scan</Trans>
            </ActionBtn>
