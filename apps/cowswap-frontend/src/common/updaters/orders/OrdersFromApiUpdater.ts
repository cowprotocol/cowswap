...
export function OrdersFromApiUpdater(): null {
  ...
  const { orders: ordersFromOrderBook, isLoading } = useOrdersFromOrderBook()
  ...
  useEffect(() => {
    updateApiOrders({ orders: ordersFromOrderBook, isLoading })
  }, [isLoading, ordersFromOrderBook, updateApiOrders])
