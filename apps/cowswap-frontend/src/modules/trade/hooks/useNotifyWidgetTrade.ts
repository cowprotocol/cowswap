...
function getTradeParamsEventPayload(tradeType: TradeType, state: TradeDerivedState): OnTradeParamsPayload {
  return {
    ...
    inputCurrencyFiatAmount: currencyAmountToBigInt(state.inputCurrencyFiatAmount),
    outputCurrencyFiatAmount: currencyAmountToBigInt(state.outputCurrencyFiatAmount),
