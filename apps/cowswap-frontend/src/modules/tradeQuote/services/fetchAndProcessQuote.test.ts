...
describe('fetchAndProcessQuote', () => {
  ...
  describe('Main fetchAndProcessQuote function', () => {
    it('should set loading state and call fetchSwapQuote for same-chain swaps', async () => {
      ...
      await fetchAndProcessQuote(mockFetchParams, sameChainQuoteParams, mockAppData, mockTradeQuoteManager)
    ...
    it('should use optimal quote for OPTIMAL price quality', async () => {
      ...
      await fetchAndProcessQuote(optimalFetchParams, mockQuoteParams, mockAppData, mockTradeQuoteManager)
  ...
  describe('fetchBridgingQuote', () => {
    ...
    it('should handle successful bridge quote with onQuoteResult callback', async () => {
      const mockBridgeQuote: BridgeQuoteResults = {
        providerInfo: { name: 'Test Provider', logoUrl: '', dappId: 'test', website: '' },
  ...
  describe('Edge cases', () => {
    it('should handle undefined appData', async () => {
      ...
      await fetchAndProcessQuote(mockFetchParams, mockQuoteParams, undefined, mockTradeQuoteManager)
    ...
    it('should handle hasParamsChanged = false', async () => {
      ...
      await fetchAndProcessQuote(noParamsChangedFetchParams, mockQuoteParams, mockAppData, mockTradeQuoteManager)
