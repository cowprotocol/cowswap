...
const trade = new TradeGp({
  ...
  inputAmountWithPartnerFee: CurrencyAmount.fromRawAmount(currency, amount * 10 ** 18),
  ...
  outputAmountWithPartnerFee: CurrencyAmount.fromRawAmount(currency, (output - 3) * 10 ** 18),
