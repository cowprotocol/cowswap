...
const defaultProps: OrderProgressBarProps = {
  ...
  totalSolvers: 52,
  surplusData: {
    surplusFiatValue: CurrencyAmount.fromRawAmount(USDCe_GNOSIS_CHAIN, '10000000'),
      ...
      <OrderProgressBar
        ...
        swapAndBridgeContext={{
          ...
          overview: {
            ...
            targetCurrency: USDCe_GNOSIS_CHAIN,
            targetAmounts: {
              sellAmount: receiveAmountInfo.afterSlippage.buyAmount,
              buyAmount: CurrencyAmount.fromRawAmount(USDCe_GNOSIS_CHAIN, '28700000'),
            },
          },
          quoteBridgeContext: {
            ...swapAndBridgeContextMock.quoteBridgeContext!,
            chainName: 'Gnosis Chain',
            bridgeFee: CurrencyAmount.fromRawAmount(USDCe_GNOSIS_CHAIN, '150000'),
            buyAmount: CurrencyAmount.fromRawAmount(USDCe_GNOSIS_CHAIN, '28700000'),
            buyAmountUsd: CurrencyAmount.fromRawAmount(USDCe_GNOSIS_CHAIN, '28700004'),
          },
          bridgingProgressContext: {
            ...swapAndBridgeContextMock.bridgingProgressContext!,
            account,
            ...
            receivedAmount: CurrencyAmount.fromRawAmount(USDCe_GNOSIS_CHAIN, '29100000'),
            receivedAmountUsd: CurrencyAmount.fromRawAmount(USDCe_GNOSIS_CHAIN, '29800000'),
          },
          statusResult: {
            status: BridgeStatus.EXECUTED,
            depositTxHash: '0x080059573e09eb94b4679a5d1369c5244ef827746fec06c8e8d6f993c54f8663',
