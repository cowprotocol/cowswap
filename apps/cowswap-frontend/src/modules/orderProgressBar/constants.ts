...
export const TRADE_ON_NEW_CHAINS_BENEFIT = msg`CoW Swap is now live on Arbitrum, Base, Polygon, and Avalanche. Switch the network toggle in the nav bar for quick, cheap transactions`
