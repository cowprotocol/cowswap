...
import { UnsupportedTokenButton } from './tradeButtonsMap'
import { getBridgeQuoteErrorTexts, getQuoteErrorTexts } from './tradeButtonsMap.utils'

import { TradeFormValidation } from '../../types'
import { TradeFormBlankButton } from '../TradeFormBlankButton'

import type { ButtonErrorConfig, ButtonComponentProps } from './tradeButtonsMap.types'

export const tradeButtonsMap: Record<
  TradeFormValidation,
  ButtonErrorConfig | React.ComponentType<ButtonComponentProps>
> = {
