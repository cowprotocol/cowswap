...
The format of the JSON follows this typescript format: <src/uniswap-override/utils/metadata.ts>
...
1. Edit the list of pages in <./src/uniswap-override/sitemap.js>
2. Run `yarn sitemap`
